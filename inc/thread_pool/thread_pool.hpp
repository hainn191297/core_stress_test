...
using ThreadPool = ThreadPoolImpl<FixedFunction<void(), 256>, //VT21 # LONGNT # if upgrade to compiler GCC 5.X, must fix to "using ThreadPool = ThreadPoolImpl<FixedFunction<void(), 512>"
                                  MPMCBoundedQueue>;
